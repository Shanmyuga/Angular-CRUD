...
export abstract class BackLogProvider {
  ...
  abstract getList(sortActive: string, order: string, pageSize: number, page: number, searchbyDept: string,searchByDesc: string ,searchByWork: string): Observable<Response>;
